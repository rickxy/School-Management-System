...
from staff_management.models import CustomUser, Staffs, Courses, Subjects, Students, SessionYearModel, Attendance, AttendanceReport, LeaveReportStaff, FeedBackStaffs, StudentResult


def ict_home(request):
    ...
    return render(request, "ict_template/ict_home_template.html", context)
