...
from . import views
from .import HodViews, StaffViews, StudentViews, FinanceViews, IctViews, HrViews, RegistrarViews, TransportViews, AcademicViews, LibraryViews, MedicalViews, ResearchViews, PlanningViews, ProcurementViews
...
urlpatterns = [
    ...
    path('finance_home/', FinanceViews.finance_home, name="finance_home"),
     ...
     # URLS for Procurement
    path('procurement_home/', ProcurementViews.procurement_home, name="procurement_home"),

      # URLS for Medical
    path('medical_home/', MedicalViews.medical_home, name="medical_home"),


      # URLS for Planning
    path('planning_home/', PlanningViews.planning_home, name="planning_home"),


     # URLS for Library
    path('library_home/', LibraryViews.library_home, name="library_home"),

    # URLS for Research
    path('research_home/', ResearchViews.research_home, name="research_home"),


     # URLS for Academic
    path('academic_home/', AcademicViews.academic_home, name="academic_home"),


    # URLS for Transport
    path('transport_home/', TransportViews.transport_home, name="transport_home"),
   


     # URLS for ICT
    path('ict_home/', IctViews.ict_home, name="ict_home"),


      # URLS for Human resource
    path('hr_home/', HrViews.hr_home, name="hr_home"),


    # URLS for  registrar
    path('registrar_home/', RegistrarViews.registrar_home, name="registrar_home"),
